const VWAResource = {
	...
	"WT": {value: "Word Ties", new: () => new WordTieProcess("WT", 1, [1, 1, 1, 0])},
	...
	"OLV-P1": {value: "On-level Passage 1", new: () => new OLVP1Process("OLV-P1", 1, [1, 1, 1, 0])},
	"OLV-P2": {value: "On-level Passage 2", new: () => new OLVP2Process("OLV-P2", 1, [1, 1, 1, 0])},
